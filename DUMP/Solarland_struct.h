...
// Enum Solarland.EAirPlaneAnimState
...
struct FSolarPlayerReport {
	...
	int32_t WinninScoreID; // 0x15c(0x04)
	int32_t Zomborg; // 0x160(0x04)
	float MvpScore; // 0x164(0x04)
	float KDA; // 0x168(0x04)
	bool IsAce; // 0x16c(0x01)
	bool IsVictory; // 0x16d(0x01)
	bool IsValid; // 0x16e(0x01)
	...
	int32_t CombatCore; // 0x40c(0x04)
	bool IsCheater; // 0x410(0x01)
	char pad_411[0x7]; // 0x411(0x07)
	struct TArray<char> SettlePunishTypes; // 0x418(0x10)
};
...
struct FCustomParamConfig {
	...
	int32_t Desc; // 0x08(0x04)
	enum class ECustomParamValueType ValueType; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
	struct FString DefaultValue; // 0x10(0x10)
	struct TArray<struct FString> ValueRange; // 0x20(0x10)
	struct TSoftClassPtr<UObject> StyleClass; // 0x30(0x28)
};
...
struct FActionWheelConfig : FTableRowBase {
	...
	struct FVector2D Offset; // 0x2c(0x08)
	char pad_34[0x4]; // 0x34(0x04)
	struct UActionWheelWidgetFunctionBase* WheelFunctionBP; // 0x38(0x08)
	struct FString InputActionName; // 0x40(0x10)
	enum class EActionWheelOperateType OperateType; // 0x50(0x01)
	char pad_51[0x3]; // 0x51(0x03)
	struct FActionWheelStyle ActionWheelStyle; // 0x54(0x70)
	char pad_C4[0x4]; // 0xc4(0x04)
	struct TArray<struct FActionWheelCommand> ActionWheelCommands; // 0xc8(0x10)
};
...
struct FForceChangeMaterialInfos {
	...
	struct TArray<struct FSoftObjectPath> MaterialPaths; // 0x20(0x10)
};
...
struct FActorMaterialInfo {
	...
	struct TMap<struct FMaterialChangeHandle, struct FLimitedMeshContainer> LimitedMeshes; // 0x100(0x50)
	struct TArray<struct FMeshMaterialInfo> MeshMaterials; // 0x150(0x10)
};
...
struct FPromptElemInfo {
	...
	int32_t Angle; // 0x24(0x04)
	bool bBlocked; // 0x28(0x01)
	char pad_29[0x3]; // 0x29(0x03)
	int32_t UVIdx; // 0x2c(0x04)
};
...
struct FMissileSwarmSkillConfig {
	...
	bool bAimDetectWorldStatic; // 0x01(0x01)
	char pad_2[0x2]; // 0x02(0x02)
	struct FVector BlockDetectSpace; // 0x04(0x0c)
	struct FVector BlockDetectSpaceCenterOffset; // 0x10(0x0c)
	struct FIntPoint MissileSumMatrix; // 0x1c(0x08)
	char pad_24[0x4]; // 0x24(0x04)
	struct FRuntimeFloatCurve AimDistanceCurve; // 0x28(0x88)
	float FallingAimMaxAddition; // 0xb0(0x04)
	char pad_B4[0x4]; // 0xb4(0x04)
	struct FRuntimeFloatCurve FallingAimAdditionPitchCurve; // 0xb8(0x88)
	struct FRuntimeFloatCurve FallingAimScalePitchCurve; // 0x140(0x88)
	struct FVector2D AimField; // 0x1c8(0x08)
	float AimUpwardDistance; // 0x1d0(0x04)
	float AimDownwardDistance; // 0x1d4(0x04)
};
...
struct FTacticalDodgeDirectionConfig {
	...
	enum class ECamShakeType CameraShake; // 0x08(0x01)
...
struct FCueContent {
	...
	struct TArray<struct FParticleSystemContent> ParticleSystemContents; // 0x90(0x10)
...
struct FRichHlinkRow : FTableRowBase {
	struct FHyperlinkStyle HlinkStyle; // 0x08(0x578)
};
...
struct FMissileBullet {
	...
	struct UParticleSystemComponent* BulletEffect; // 0x60(0x08)
	struct UParticleSystemComponent* RibbonTrajectoryEffect; // 0x68(0x08)
	char pad_70[0x10]; // 0x70(0x10)
	struct AMissileSwarmLauncher* Launcher; // 0x80(0x08)
...
struct FMissileSwarmSpawnParameter {
	struct FVector EjectRelativeLoc; // 0x00(0x0c)
	struct FRotator EjectRot; // 0x0c(0x0c)
	float Delay; // 0x18(0x04)
...
struct FConfigMeshData {
	...
	struct FVector2D ScreenOffset; // 0xe8(0x08)
...
// Size: 0x478 (Inherited: 0x428)
struct FSCustomMode_PlayerReport : FSolarPlayerReport {
	struct TMap<int32_t, int32_t> RewardItems; // 0x428(0x50)
};
...
struct FPlaygroundEffect {
	...
	float SpawnDelay; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
	struct UParticleSystemComponent* Handle; // 0x10(0x08)
};
...
struct FSolarBotMemberInfo {
	...
	char pad_9[0x7]; // 0x09(0x07)
	struct TArray<enum class ESolarTablesEnum_CharacterType> PreferPickHeroTypes; // 0x10(0x10)
	struct TMap<enum class EBotInteractCondition, float> MemberEmojiTimeStamp; // 0x20(0x50)
	struct TMap<enum class EBotInteractCondition, float> MemberResponseTimeStamp; // 0x70(0x50)
};
...
struct FSolarBotThreatConfig {
	...
	float PeripheralVisionAngleDegrees; // 0x18(0x04)
	float SightIncreaseBase; // 0x1c(0x04)
	float SightIncreaseDistanceFactor; // 0x20(0x04)
	float SightDecreaseBase; // 0x24(0x04)
	float SightDecreaseDistanceFactor; // 0x28(0x04)
	float SightDecreaseMax; // 0x2c(0x04)
	float SightMaxValue; // 0x30(0x04)
	float HearingAddBase; // 0x34(0x04)
	float HearingAddDistanceFactor; // 0x38(0x04)
	float HearingDecreasePerTick; // 0x3c(0x04)
	float HearingMaxValue; // 0x40(0x04)
	float HitSoundAlertRange; // 0x44(0x04)
	float BotThreatFactor; // 0x48(0x04)
	float PlayerThreatFactor; // 0x4c(0x04)
	float DeathVergeFactor; // 0x50(0x04)
	float MassInvisibilityPrepareFactor; // 0x54(0x04)
	float MaxDistanceThreatFactor; // 0x58(0x04)
	float DistanceThreatFactorDecayRate; // 0x5c(0x04)
	float AccompanyThreatMaxValue; // 0x60(0x04)
	float AccompanyThreatAddBase; // 0x64(0x04)
	float AccompanyDecreasePerTick; // 0x68(0x04)
};
...
struct FSolarBotTeamHeroPickFormation {
	bool bFormatByCharType; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct TArray<enum class ESolarTablesEnum_CharacterType> CharTypeFormation; // 0x08(0x10)
};

// ScriptStruct Solarland.SolarBotTeamBuildRule
// Size: 0x50 (Inherited: 0x00)
struct FSolarBotTeamBuildRule {
	struct TMap<struct FGameplayTag, float> TagWeights; // 0x00(0x50)
};
...
struct FMissileSwarmParams : FGameplayAbilityTargetData {
	struct FVector MissileStartCenterPoint; // 0x08(0x0c)
	struct FVector MissileTargetCenterPoint; // 0x14(0x0c)
	struct FRotator ViewRotation; // 0x20(0x0c)
	char pad_2C[0x4]; // 0x2c(0x04)
};
...
struct FVehicleAbilityWidgets {
	...
	struct UCommonLazyImage* LazyImage_Skill; // 0x08(0x08)
	struct USolarTextBlock* Txt_Skill; // 0x10(0x08)
	struct UGaugeImage* Img_CD; // 0x18(0x08)
	struct UTextBlock* Txt_CD; // 0x20(0x08)
	struct UImage* Img_Disable; // 0x28(0x08)
	struct UCanvasPanel* Panel_Duration; // 0x30(0x08)
	struct UMaterialInstanceDynamic* Progress_DurationMat; // 0x38(0x08)
	struct UWidgetAnimation* Anim_CDFinished; // 0x40(0x08)
	struct UWidgetAnimation* Anim_ActivedLoop; // 0x48(0x08)
...
struct FMatUpdateParams {
	...
	struct UCurveFloat* MatCurve; // 0x08(0x08)
};
...
struct FGraphicsUserSettings {
	...
	bool VSyncIsEnabled; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	struct FFloatValue AdaptationUIValue; // 0x08(0x04)
	bool EnableDynamicShadow; // 0x0c(0x01)
	enum class ESolarGraphicsQualityLevel SelectQualityLevel; // 0x0d(0x01)
	char pad_E[0x2]; // 0x0e(0x02)
	int32_t SavedVersion; // 0x10(0x04)
	char pad_14[0x2c]; // 0x14(0x2c)
};
...
struct FGamepadSettings {
	...
	int32_t AimModeID; // 0x88(0x04)
	int32_t SprintModeID; // 0x8c(0x04)
	struct FConditionValue MainHorizontalSensitivity; // 0x90(0x08)
	struct FConditionValue MainVerticalSensitivity; // 0x98(0x08)
	int32_t RightStickSensitivityID; // 0xa0(0x04)
	int32_t RightStickResponseCurveID; // 0xa4(0x04)
	bool bInvertedLook; // 0xa8(0x01)
	char pad_A9[0x3]; // 0xa9(0x03)
	int32_t LeftStickDeadzoneID; // 0xac(0x04)
	int32_t RightStickDeadzoneID; // 0xb0(0x04)
	int32_t TriggerDeadzoneID; // 0xb4(0x04)
	struct FFloatValue CursorSpeed; // 0xb8(0x04)
	int32_t VibrationLevelID; // 0xbc(0x04)
	bool bEnableAimAssist; // 0xc0(0x01)
...
struct FSolarSkillProjectileData {
	...
	float GravityScale; // 0x60(0x04)
	float PredictAngle; // 0x64(0x04)
	struct FName StartSocketName; // 0x68(0x08)
	struct FVector StartSocketOffset; // 0x70(0x0c)
	bool bDisplayHoldModel; // 0x7c(0x01)
	char pad_7D[0x3]; // 0x7d(0x03)
	struct FName HoldSocketName; // 0x80(0x08)
...
struct FSolarSummonCondition {
	...
	float RoomCheckHalfHeight; // 0x44(0x04)
	bool bKeepPreviewUpright; // 0x48(0x01)
...
struct FSolarTablesData_GameModeMain : FSolarTablesDataBase {
	...
	struct FString Icon_recruit_issue; // 0x58(0x10)
	struct FString Icon_mini; // 0x68(0x10)
	bool Enabled; // 0x78(0x01)
	bool IfRecruitShow; // 0x79(0x01)
	char pad_7A[0x2]; // 0x7a(0x02)
	int32_t ModeType; // 0x7c(0x04)
	int32_t OutcomeSet; // 0x80(0x04)
	int32_t LifeTime; // 0x84(0x04)
	struct TArray<int32_t> AccessClient; // 0x88(0x10)
	struct TArray<int32_t> AccessServer; // 0x98(0x10)
	struct TArray<int32_t> AccessAccount; // 0xa8(0x10)
	struct TArray<int32_t> AccessActivity; // 0xb8(0x10)
	int32_t UnlockLvl; // 0xc8(0x04)
	char pad_CC[0x4]; // 0xcc(0x04)
	struct TArray<int32_t> MatchRule; // 0xd0(0x10)
	int32_t DefaultMatchRule; // 0xe0(0x04)
	int32_t Backpack; // 0xe4(0x04)
	struct FString UIConfig; // 0xe8(0x10)
	struct FString ModeConfig; // 0xf8(0x10)
	struct FString Parameters; // 0x108(0x10)
	int32_t DefaultSelect; // 0x118(0x04)
	bool AIMatch; // 0x11c(0x01)
	char pad_11D[0x3]; // 0x11d(0x03)
	struct FString SettlementBPPath; // 0x120(0x10)
	bool ReEnterBattle; // 0x130(0x01)
	bool IsAutoFillTeammate; // 0x131(0x01)
	char pad_132[0x6]; // 0x132(0x06)
	struct TArray<int32_t> CustomRoomNum; // 0x138(0x10)
	bool GetSupplyBox; // 0x148(0x01)
	char pad_149[0x3]; // 0x149(0x03)
	int32_t ChunkID; // 0x14c(0x04)
	struct TArray<int32_t> ChunkIdList; // 0x150(0x10)
	enum class ESolarTablesEnum_ClassModeType ClassModeType; // 0x160(0x01)
	bool WarmUp; // 0x161(0x01)
	bool EnableCustomRoomReplay; // 0x162(0x01)
...
struct FSolarTablesData_GunProperty : FSolarTablesDataBase {
	...
	struct FString BigIcon; // 0x78(0x10)
	int32_t WeaponLv; // 0x88(0x04)
	bool UseWeaponAccessory; // 0x8c(0x01)
	char pad_8D[0x3]; // 0x8d(0x03)
	int32_t WeaponAccessory1; // 0x90(0x04)
	int32_t WeaponAccessory2; // 0x94(0x04)
	int32_t WeaponAccessory3; // 0x98(0x04)
	int32_t WeaponAccessory4; // 0x9c(0x04)
	int32_t WeaponAccessory5; // 0xa0(0x04)
...
struct FSolarVirtualBullet {
	...
	struct TArray<struct AActor*> IgnoreHitedActors; // 0x30(0x10)
	char pad_40[0x130]; // 0x40(0x130)
...
struct FSolarVirtualBulletSpawnParameter {
	...
	struct FVector HitTargetRelativeLocation; // 0x98(0x0c)
	char pad_A4[0x4]; // 0xa4(0x04)
};
...
struct FFireMode {
	...
	struct UParticleSystemComponent* ChargingEffect; // 0x38(0x08)
};
