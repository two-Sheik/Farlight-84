...
struct UParticleSystemWidget : UWidget {
	...
	void SetReactivate(bool bActivateAndReset); // Function UIParticleSystem.ParticleSystemWidget.SetReactivate // (Final|Native|Public|BlueprintCallable) // @ game+0x815270
	void ActivateParticles(bool bActive, bool bReset); // Function UIParticleSystem.ParticleSystemWidget.ActivateParticles // (Final|Native|Public|BlueprintCallable) // @ game+0x8151a0
};
